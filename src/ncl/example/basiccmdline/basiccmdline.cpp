...
unsigned BASICCMDLINE::CharLabelToNumber(
  NxsString)	/* is the character label to be translated to character number */
	{
	return 0;
	}
...
void BASICCMDLINE::PurgeBlocks()
	...
	unaligned	= new NxsUnalignedBlock(taxa, assumptions);
...
unsigned BASICCMDLINE::TaxonLabelToNumber(
  NxsString )	/* is the taxon label to be translated to a taxon number */
	{
	return 0;
	}
