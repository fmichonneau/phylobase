...
/*----------------------------------------------------------------------------------------------------------------------
|	Copy constructors calls CopyFrom member function to make a copy of the supplied NxsDiscreteDatum object `other'.
*/
NxsDiscreteDatum::NxsDiscreteDatum(
...
|	and of course useful in creating the copy constructor and assignment operator needed if NxsDiscreteDatum objects are
|	used in STL containers.
*/
void NxsDiscreteDatum::CopyFrom(
  const NxsDiscreteDatum & other)	/* is the source NxsDiscreteDatum object  */
	{
	if (states != NULL)
		{
		delete [] states;
