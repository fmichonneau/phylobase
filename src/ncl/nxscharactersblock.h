...
class NxsCharactersBlock
  : public NxsCharactersBlockAPI, public NxsTaxaBlockSurrogate
	...
	public:
		...
		//	This function is sensitive to the gapmode setting
		...
		*/
		...
		// The gapmode setting basically just holds the value for the client code's convenience.
		//	It only affects post-read operations, such as GetNamedStateSetOfColumn. 
